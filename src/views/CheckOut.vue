<template>
  <div class="checkout">
    <v-container fluid class="ms-0 pa-0">
      <v-row>
        <v-col cols="7" style="padding: 60px 60px 0px 120px">
          <v-card class="w-100" color="white" elevation="0">
            ...
            <v-card-title
              class="px-0"
              style="font-size: 14px; font-weight: 700; white-space: pre-wrap"
            >
              Shipping Address
            </v-card-title>
            ...
            />
            <div
              class="city d-flex align-center justify-center"
              style="gap: 15px"
            >
              <input
                class="pa-2 mt-4"
        ...
        <v-col cols="5">
          <v-card
            ...
            width="100%"
            height="100%"
            style="padding: 60px 120px 0px 60px"
          >
            <v-card
              elevation="0"
            ...
            >
              ...
              <div class="title-parent flex-grow-1">
                ...
                >
                <v-card-text
                  style="font-size: 14px; white-space: pre-wrap; color: #7b7b77"
